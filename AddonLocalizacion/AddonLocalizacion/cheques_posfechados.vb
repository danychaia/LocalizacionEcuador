Public Class cheques_posfechados

    Private XmlForm As String = Replace(Application.StartupPath & "\cheques_Posfechados.srf", "\\", "\")
    ...
    Public Sub New()
        ...
        Try
            ...
            If UDT_UF.ActivateFormIsOpen(SBO_Application, "CPEPOSFE_") = False Then
                LoadFromXML(XmlForm)
                oForm = SBO_Application.Forms.Item("CPEPOSFE_")
                oForm.Left = 400
                oForm.Visible = True
                oMatrix = oForm.Items.Item("Item_32").Specific
                oForm.PaneLevel = 1
